...
bq query --max_rows 1  --allow_large_results --destination_table "instacart.df_prior2" --flatten_results --replace "
SELECT
a.order_id order_id,
a.product_id product_id,
a.add_to_cart_order add_to_cart_order,
a.reordered reordered,
a.user_id user_id,
a.eval_set eval_set,
a.order_number order_number,
a.order_dow order_dow,
a.order_hour_of_day order_hour_of_day,
...
b.cum_days as cumdays,
b.max_cum_days as max_cum_days,
