...
def features(selected_orders, labels_given=False):
    ...
    df = pd.DataFrame({'order_id': order_list, 'product_id': product_list, 'user_id': user_list})
...
with open('train_baseline.pkl', 'wb') as f:
    pickle.dump((df_train, labels), f, -1)

df_test, _ = features(test_orders)

with open('test_baseline.pkl', 'wb') as f:
